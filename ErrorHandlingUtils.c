...
/**
 * print_error - prints an error message along with relevant data
 * @info: the parameter & return struct data
 * @estr: string containing specified errors
 * Return: 0 if no numbers in string, converted number with other meaning
 *        -1 on error
 */
